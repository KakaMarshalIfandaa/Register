...
<body>
    ...
    <h1 class="text-center">Form Edit Data User</h1>
    ...
    <form action="<?php echo base_url('index.php/user/action_edit/'.$data['id']) ?>"method="post">
                ...
                <input value="<?php echo $data['username'] ?>" type="text" class="form-control" name="username" required><br>
                <label for="" class="form-label">Email</label><br>
                <input value="<?php echo $data['email'] ?>" type="email" class="form-control" name="email" required><br>
                <label for="" class="form-label">Password</label><br>
                <input value="<?php echo $data['password'] ?>" type="password" class="form-control" name="password"  required><br>
